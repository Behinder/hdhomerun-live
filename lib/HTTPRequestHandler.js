const Stream = require('./Streaming.js');
const Scanner = require('./Scanner.js');
const util = require('util');
const IPTVChannel = require('./IPTVChannel.js');
...
class HTTPRequestHandler {
    ...
    // Główna funkcja na odtworzenie danego kanału
    Play(req, res) {
        ...
        // const ChannelModuleName = ChannelConfig.GuideName.toLowerCase(); NIEPOTRZEBNE
        //const ChannelModule = require('../channels/' + ChannelModuleName + '.js'); NIEPOTRZEBNE
        
        // new Chanel object should be created taking settings from settings and some initiaisers and properties
        // similar as it is in channels/bloom.js
        ...
        // THIS IS LINE I CREATED
        const Channel = new IPTVChannel(this.GuideName,this.GuideNumber);
